...
resource "aws_instance" "my_instance" {
  for_each = tomap({
    Ansible-Master = "ami-0df368112825f8d8f", # ubuntu
    worker-server-1 = "ami-0df368112825f8d8f", #ubuntu
    worker-server-2 = "ami-09de149defa704528", #RedHat
    worker-server-3 = "ami-08f9a9c699d2ab3f9" # CentOs / Amazon Linux 2
  }) # meta argument
